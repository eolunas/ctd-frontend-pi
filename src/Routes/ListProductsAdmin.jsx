        ...
        <table className="w-full border-collapse">
          ...
          <thead>
            <tr className="bg-gray-800 text-gray-200">
              <th className="px-4 py-2 border-t border-l  border-cyan-500">ID</th>
              <th className="px-4 py-2 border-t  border-cyan-500">Nombre</th>
              <th className="px-4 py-2 border-t  border-r border-cyan-500">Acciones</th>
            </tr>
          </thead>
          <tbody>
            {products.map((product) => (
              <tr key={product.id}>
                <td className="px-4 py-2 text-center border border-cyan-500">{product.id}</td>
                <td className="px-4 py-2 text-center border border-cyan-500">{product.name}</td>
