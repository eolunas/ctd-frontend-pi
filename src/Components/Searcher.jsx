...
const Searcher = () => {
  ...
  return (
    ...
    >
      ...
      <form
        className={`
          flex align-middle justify-between bg-white m-auto mb-5 p-1 rounded-lg w-full gap-2 z-10
          md:w-5/6 
        `}
      >
        <div
          className={`
              flex flex-col gap-2 basis-[100%]`}
        >
          <div className="flex justify-center items-center gap-3 w-full">
            <div className="flex justify-center items-center relative w-full">
              <Select
                className="w-full"
                placeholder="Seleccine una categoría"
